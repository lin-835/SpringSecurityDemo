...
//        inMemoryUserDetailsManager.createUser(User.withUsername("root").password("{bcrypt}$2a$10$dQXe342VwTkzz7BCEM/sSezVcfbw.hLCewDQBSJ4F6jTVk2OhI2vS").roles("admin").build());
